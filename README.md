# My testpage for the book: Invent to learn with the micro:bit
...
| 0.2     | Animation             | [view on github](https://github.com/microbitfun/animation)    | <div style="position:relative;height:calc(300px + 5em);width:100%;overflow:hidden;"><iframe style="position:absolute;top:0;left:0;width:100%;height:100%;" src="https://makecode.microbit.org/---codeembed#pub:#C1" allowfullscreen="allowfullscreen" frameborder="0" sandbox="allow-scripts allow-same-origin"></iframe></div>  |
